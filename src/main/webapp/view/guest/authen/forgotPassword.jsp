  ...
  <style>
    * {
    ...
    .home-button:hover {
      ...
      box-shadow: 0 6px 15px rgba(60, 170, 159, 0.35);
    }
    ...
    .input-group input:focus {
      border-color: #3CAA9F;
      box-shadow: 0 0 0 4px rgba(60, 170, 159, 0.15);
    }
    ...
    .input-group i {
      ...
      color: #3CAA9F; font-size: 16px; transition: all 0.3s ease;
    }
    ...
    .btn:hover {
      transform: translateY(-2px);
      box-shadow: 0 14px 28px rgba(60, 170, 159, 0.35);
    }

    .btn:active {
      transform: translateY(0);
      box-shadow: 0 8px 16px rgba(60, 170, 159, 0.25);
    }
