...
<head>
    ...
    <style>
        * {
        ...
        h2 { color: #2F8F86; font-size: 28px; margin-bottom: 22px; text-align: center; }
        ...
        .input-group input:focus, .input-group select:focus { border-color: #3CAA9F; box-shadow: 0 0 0 4px rgba(60, 170, 159, 0.15); }
